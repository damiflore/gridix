...
const testBoundingBoxShapeContact = (a, b) => {
  ...
  if (
    aBoundingBoxShapeName === "circle" &&
    bBoundingBoxShapeName === "circle"
  ) {
    return circleHitCircle(a, b);
  }

  if (
    aBoundingBoxShapeName === "rectangle" &&
    bBoundingBoxShapeName === "rectangle"
  ) {
...
const circleHitRectangle = (circle, rectangle) => {
  ...
  const distance = Math.sqrt(
    distanceWithClosestX * distanceWithClosestX +
      distanceWithClosestY * distanceWithClosestY,
  );
