...
const moveGameObjectToCell = (gameObject, cellIndex, worldGrid) => {
  gameObject.centerX = centerXFromCellX(cellXFromCellIndex(cellIndex, worldGrid), worldGrid)
  gameObject.centerY = centerYFromCellY(cellYFromCellIndex(cellIndex, worldGrid), worldGrid)
}
