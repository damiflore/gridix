...
const desertImageUrl = new URL("./desert.png", import.meta.url)
const desertJsonUrl = new URL("./desert.json", import.meta.url)
...
function preload() {
  this.load.image("tiles", String(desertImageUrl))
  this.load.tilemapTiledJSON("map", String(desertJsonUrl))
}
