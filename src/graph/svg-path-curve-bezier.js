...
const getControlPoint = ({
  ...
  const opposedLineDistance = getDistanceBetweenVectors(previousPoint, nextPoint)
  const opposedLineAngle = Math.atan2(nextPoint.y - previousPoint.y, nextPoint.x - previousPoint.x)
