...
const particleUrl = new URL("./particle.png", import.meta.url)
const anvilUrl = new URL("./popart_anvil.png", import.meta.url)
...
export class Game extends GameObject {
  constructor() {
    ...
    assets.enqueueImage("anvil", String(anvilUrl))
    assets.enqueueImage("star", String(particleUrl))
  ...
  onAssetsLoadded() {
    ...
    const tween = new Tween({ y: [0, sprite.y - 110] }, 1, { loop: true, repeatDelay: 1 })
    emitter.add(tween)
    ...
    sprite.add(
      new Tween(
        { color: [0xffffaa, 0xff0000, 0xffffaa] },
        0.5,
        { delay: 0.7, loop: true, repeatDelay: 1.5 },
        { color: ColorHelper.lerpHSV },
      ),
    )
    sprite.add(
      new Tween({ scaleY: [1, 0.9, 1] }, 0.5, { delay: 0.69, loop: true, repeatDelay: 1.5 }),
    )

    const textField = new TextField(
      "Black Engine v0.5.10",
      "Titillium Web",
      0xffffff,
      15,
      FontStyle.NORMAL,
